  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Professional design tool variants
        tool: "bg-tool-bg border border-panel-border text-foreground hover:bg-tool-hover hover:shadow-tool",
        panel: "bg-panel-bg border border-panel-border text-foreground hover:bg-muted/50",
        canvas: "bg-canvas-bg border border-canvas-border text-foreground hover:bg-muted/30",
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:bg-primary/90 shadow-soft",
